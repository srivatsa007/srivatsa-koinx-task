        ...
        <div className="  bg-white p-6 rounded-lg shadow-md w-full max-w-4xl  mb-8">
          ...
          <div className="mb-4">
            ...
            <p>
              ...
              massa hendrerit convallis duis ac. Mi adipiscing semper
              scelerisque porttitor pulvinar nunc risus. Fermentum potenti
              lacinia congue ipsum fames amet dui. Purus ultrices tincidunt
          ...
          <div className="mb-4">
            ...
            <div>
              <p className="my-4">
                ...
                commodi labore fuga. Corrupti obcaecati, repudiandae
                reprehenderit nisi ipsa similique?
              </p>
            </div>
          </div>
        </div>
